...
import (
	...
	jupyratororgv1 "github.com/kernel_manager_controller/api/v1"
	"github.com/kernel_manager_controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(jupyratororgv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "kernel-manager-controller",
	...
	if err = (&controller.KernelManagerReconciler{
